...
require_thank_you_access('scheme', './#implementation');
?>
<!doctype html>
<html lang="ru">
<head>
  ...
  <title>Спасибо — запрос на подбор схемы дозирования SILVER Ag+ принят</title>
  <meta name="description" content="Запрос на подбор схемы дозирования SILVER Ag+ принят.">
...
<body class="thank-you-page">
  ...
  <main class="thank-you-main">
    <section class="thank-you-card" aria-labelledby="thank-you-title">
      ...
      <p>ЗАПРОС ПРИНЯТ · СХЕМА ДОЗИРОВАНИЯ</p>
      <h1 id="thank-you-title">Спасибо!</h1>
      <h2>Запрос на подбор схемы дозирования принят</h2>
      <p class="thank-you-card__lead">Технолог свяжется с вами, чтобы уточнить параметры линии и предложить схему дозирования SILVER Ag+.</p>
